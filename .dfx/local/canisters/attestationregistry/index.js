...
import { idlFactory } from './attestationregistry.did.js';
export { idlFactory } from './attestationregistry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ATTESTATIONREGISTRY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./attestationregistry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the attestationregistry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./attestationregistry.did.js")._SERVICE>}
 */
export const attestationregistry = createActor(canisterId);

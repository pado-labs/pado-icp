...
import { idlFactory } from './schemaregistry.did.js';
export { idlFactory } from './schemaregistry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SCHEMAREGISTRY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./schemaregistry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the schemaregistry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./schemaregistry.did.js")._SERVICE>}
 */
export const schemaregistry = createActor(canisterId);

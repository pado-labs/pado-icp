...
import { idlFactory } from './schema.did.js';
export { idlFactory } from './schema.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.SCHEMA_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./schema.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the schema canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./schema.did.js")._SERVICE>}
 */
export const schema = createActor(canisterId);

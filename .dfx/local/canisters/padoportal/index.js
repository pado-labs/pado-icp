...
import { idlFactory } from './padoportal.did.js';
export { idlFactory } from './padoportal.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.PADOPORTAL_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./padoportal.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the padoportal canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./padoportal.did.js")._SERVICE>}
 */
export const padoportal = createActor(canisterId);
